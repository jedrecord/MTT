...
*       https://app.skaffolder.com/#!/register?friend=5dc8cd2ef1ef4518a53815dd
*
...
function getConnection() {
	...
	global $db_MTT_db_Url, $db_MTT_db_User, $db_MTT_db_Pass, $db_MTT_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_MTT_db_Url.";dbname=".$db_MTT_db_DbName, $db_MTT_db_User, $db_MTT_db_Pass);
